...
public class Bezier {
    ...
    public PenPoint startPoint;
    public PenPoint control1;
    public PenPoint control2;
    public PenPoint endPoint;

    public Bezier set(PenPoint startPoint, PenPoint control1,
                      PenPoint control2, PenPoint endPoint) {
